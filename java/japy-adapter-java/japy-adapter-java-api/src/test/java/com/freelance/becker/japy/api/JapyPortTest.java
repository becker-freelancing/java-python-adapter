...
class JapyPortTest {
    ...
    static Stream<Arguments> parametersWithoutArguments() {
        return Stream.of(
                Arguments.of(new PythonMethod("void_method_with_one_arg", List.of(new PythonMethodArgument<>("Thomas")))),
                Arguments.of(new PythonMethod("void_method_with_two_args", List.of(new PythonMethodArgument<>("Thomas"), new PythonMethodArgument<>("Deines")))),
    ...
    static Stream<Arguments> parametersWithArguments() {
        return Stream.of(
                Arguments.of(new PythonMethod("return_method_with_one_arg", List.of(new PythonMethodArgument<>("Thomas")))),
                Arguments.of(new PythonMethod("return_method_with_two_args", List.of(new PythonMethodArgument<>("Thomas"), new PythonMethodArgument<>("Deines")))),
                Arguments.of(new PythonMethod("return_method_with_two_args_and_two_returns", List.of(new PythonMethodArgument<>("Thomas"), new PythonMethodArgument<>("Deines")))),
